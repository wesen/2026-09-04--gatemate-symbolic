---
Title: Dataflow API and debug register reference
...
Owners: []
RelatedFiles:
    - Path: repo://cmd/dataflow-lab/main.go
      Note: Checked example CLI
    - Path: repo://elastic_dataflow/rtl/dataflow_link.sv
      Note: UART control implementation
    - Path: repo://pkg/dataflow/protocol.go
      Note: Request framing and hardware debug decoding
    - Path: repo://pkg/dataflow/serial.go
      Note: Wire ownership and complete paused snapshots
ExternalSources: []
Summary: ""
LastUpdated: 2026-09-04T20:47:48.955145-04:00
WhatFor: ""
WhenToUse: ""
---


# Dataflow API and debug register reference
