#!/usr/bin/env python3
"""Create the separately requested Go/React IDE design within the active ticket."""
from pathlib import Path
T=Path(__file__).resolve().parents[1]
p=T/'design-doc/02-dataflow-ide-go-react-architecture-and-intern-implementation-guide.md'
...
'''
p.write_text('---'+front+'---\n'+body.strip()+'\n')
tasks=T/'tasks.md';s=tasks.read_text().replace('P5: Finish stress tests, measurements, documentation, and handoff.', 'P5: Qualify engine stress tests, measurements, and physical debug snapshots.')
s+='- [ ] P6: Implement Go React IDE, scenario projects, inspectors, and history.\n- [ ] P7: Validate physical IDE integration and complete documentation/handoff.\n';tasks.write_text(s)
print(f'Wrote {len(body.split())} IDE guide words')
