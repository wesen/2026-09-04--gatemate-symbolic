...
p=root/'reference/03-implemented-laboratory-handoff-and-screenshot-atlas.md'
front='---'+p.read_text().split('---',2)[1]+'---\n\n'
p.write_text(front+'''# Implemented laboratory handoff and screenshot atlas
...
''')
for name in ['design-doc/01-elastic-dataflow-engine-intern-analysis-design-and-implementation-guide.md','design-doc/02-dataflow-ide-go-react-architecture-and-intern-implementation-guide.md']:
...
p=root/'index.md';s=p.read_text().replace('- [Detailed diary]', '- [Implemented API and debug pages](reference/02-dataflow-api-and-debug-register-reference.md)\n- [Handoff and screenshot atlas](reference/03-implemented-laboratory-handoff-and-screenshot-atlas.md)\n- [Detailed diary]');p.write_text(s)
