...
Go 1.27.0 is a major release of Go. Read the [Go 1.27 Release Notes](/doc/go1.27) for more information.

### Minor revisions

go1.27.1 (released 2026-09-01) includes fixes to cgo, the compiler, the runtime, the `go fix` command, and the `database/sql`, `debug/elf`, `encoding/json`, `net/http`, `os`, `simd`, and `simd/archsimd` packages. See the [Go 1.27.1 milestone](https://github.com/golang/go/issues?q=milestone%3AGo1.27.1+label%3ACherryPickApproved) on our issue tracker for details.

## go1.26.0 (released 2026-02-10)

Go 1.26.0 is a major release of Go. Read the [Go 1.26 Release Notes](/doc/go1.26) for more information.
...
go1.26.8 (released 2026-09-01) includes fixes to cgo, the compiler, the runtime, and the `debug/elf` and `os` packages. See the [Go 1.26.8 milestone](https://github.com/golang/go/issues?q=milestone%3AGo1.26.8+label%3ACherryPickApproved) on our issue tracker for details.
...
go1.25.13 (released 2026-08-13) includes security fixes to the `go` command, and the `crypto/tls`, `encoding/asn1`, `encoding/xml`, `html/template`, `net/http`, and `net/url` packages, as well as bug fixes to the compiler, the runtime, and the `crypto/tls` and `os` packages. See the [Go 1.25.13 milestone](https://github.com/golang/go/issues?q=milestone%3AGo1.25.13+label%3ACherryPickApproved) on our issue tracker for details.
...
go1.24.12 (released 2026-01-15) includes security fixes to the `go` command, and the `archive/zip`, `crypto/tls`, and `net/url` packages, as well as bug fixes to the compiler, the runtime, and the `crypto/tls` and `os` packages. See the [Go 1.24.12 milestone](https://github.com/golang/go/issues?q=milestone%3AGo1.24.12+label%3ACherryPickApproved) on our issue tracker for details.
