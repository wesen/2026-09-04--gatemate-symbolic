---
Title: Programmable dataflow workbench intern analysis design and implementation guide
...
RelatedFiles:
    - Path: repo://elastic_dataflow/rtl/dataflow_core.sv
      Note: Execution, routing and physical debug state
    - Path: repo://elastic_dataflow/rtl/dataflow_link.sv
      Note: UART ownership and new command sequencing
    - Path: repo://internal/dataflowide/session.go
      Note: Session generations and mutation ownership
    - Path: repo://pkg/dataflow/types.go
      Note: Typed values and descriptors to generalize
    - Path: repo://web/src/dataflow/Graph.tsx
      Note: Fixed graph visualization to generalize
ExternalSources: []
Summary: ""
LastUpdated: 2026-09-04T22:09:27.627610919-04:00
WhatFor: ""
WhenToUse: ""
---
