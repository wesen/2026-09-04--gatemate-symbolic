...
- [x] Design semantic state, trace format, memory interfaces, and precise fault boundaries.
- [x] Implement independent recursive reference and deterministic full-snapshot baseline; verify 92 solutions and first board.
