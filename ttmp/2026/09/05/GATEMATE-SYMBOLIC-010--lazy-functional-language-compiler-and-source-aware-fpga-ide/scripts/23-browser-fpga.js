async (page) => {
 ...
 await page.screenshot({path:base+'/05-fpga-loaded-source.png',fullPage:true});
 ...
 await page.screenshot({path:base+'/06-fpga-shared-result-and-updates.png',fullPage:true});
 ...
 await page.screenshot({path:base+'/07-fpga-closure-environment.png',fullPage:true});
 ...
 await page.screenshot({path:base+'/08-fpga-eight-square-stream.png',fullPage:true});
