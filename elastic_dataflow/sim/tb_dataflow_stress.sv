...
module tb_dataflow_stress;
 ...
 dataflow_core #(.INPUT_DEPTH(DEPTH),.COMPLETION_DEPTH(DEPTH),.OUTPUT_DEPTH(DEPTH),.MUL_LATENCY(LATENCY)) dut(.debug_control_valid(1'b0),.debug_flags(8'b0),.debug_node(8'hff),.debug_context(8'hff),.halted(),
