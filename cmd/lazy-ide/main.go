...
import (
	...
	ide "github.com/wesen/2026-09-04--gatemate-symbolic/internal/lazyide"
	df "github.com/wesen/2026-09-04--gatemate-symbolic/pkg/lazy"
...
func NewCommand() *Command {
	return &Command{cmds.NewCommandDescription("lazy-ide", cmds.WithShort("Run a local lazy heap inspector; resets the selected engine on startup"), cmds.WithFlags(
		fields.New("listen", fields.TypeString, fields.WithDefault("127.0.0.1:18090")),
